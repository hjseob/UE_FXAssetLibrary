...
#include "FXAssetLibEditorMode.generated.h"
 ...
 */
UCLASS()
class UFXAssetLibEditorMode : public UEdMode
{
	GENERATED_BODY()

public:
	const static FEditorModeID EM_FXAssetLibEditorModeId;

	static FString SimpleToolName;
	static FString InteractiveToolName;

	UFXAssetLibEditorMode();
	virtual ~UFXAssetLibEditorMode();

...
#include "FXAssetLibInteractiveTool.h"
...
#define LOCTEXT_NAMESPACE "UFXAssetLibInteractiveTool"

/*
 * ToolBuilder
 */

UInteractiveTool* UFXAssetLibInteractiveToolBuilder::BuildTool(const FToolBuilderState & SceneState) const
{
	UFXAssetLibInteractiveTool* NewTool = NewObject<UFXAssetLibInteractiveTool>(SceneState.ToolManager);
...
UFXAssetLibInteractiveToolProperties::UFXAssetLibInteractiveToolProperties()
{
...
void UFXAssetLibInteractiveTool::SetWorld(UWorld* World)
{
	check(World);
...
void UFXAssetLibInteractiveTool::Setup()
{
	...
	Properties = NewObject<UFXAssetLibInteractiveToolProperties>(this, "Measurement");
...
void UFXAssetLibInteractiveTool::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
...
FInputRayHit UFXAssetLibInteractiveTool::CanBeginClickDragSequence(const FInputDeviceRay& PressPos)
{
...
void UFXAssetLibInteractiveTool::OnClickPress(const FInputDeviceRay& PressPos)
{
...
void UFXAssetLibInteractiveTool::OnClickDrag(const FInputDeviceRay& DragPos)
{
	UpdatePosition(DragPos.WorldRay);
}


FInputRayHit UFXAssetLibInteractiveTool::FindRayHit(const FRay& WorldRay, FVector& HitPos)
{
...
void UFXAssetLibInteractiveTool::UpdatePosition(const FRay& WorldRay)
{
...
void UFXAssetLibInteractiveTool::UpdateDistance()
{
	Properties->Distance = FVector::Distance(Properties->StartPoint, Properties->EndPoint);
}


void UFXAssetLibInteractiveTool::OnPropertyModified(UObject* PropertySet, FProperty* Property)
{
...
void UFXAssetLibInteractiveTool::Render(IToolsContextRenderAPI* RenderAPI)
{

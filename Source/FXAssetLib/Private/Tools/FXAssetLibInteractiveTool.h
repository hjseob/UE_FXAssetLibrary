...
#include "FXAssetLibInteractiveTool.generated.h"


/**
 * Builder for UFXAssetLibInteractiveTool
 */
UCLASS()
class FXASSETLIB_API UFXAssetLibInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
/**
 * Property set for the UFXAssetLibInteractiveTool
 */
UCLASS(Transient)
class FXASSETLIB_API UFXAssetLibInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UFXAssetLibInteractiveToolProperties();
...
/**
 * UFXAssetLibInteractiveTool is an example Tool that allows the user to measure the 
 ...
 */
UCLASS()
class FXASSETLIB_API UFXAssetLibInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UFXAssetLibInteractiveToolProperties> Properties;
